...
output:
  ...
  word_document:
    toc: yes
    toc_depth: 2
subtitle: Modified by Johnson Odejide on January 15 2023
---
...
A look at the histogram shows that the data is skewed right. Furthermore, the qqplot reveals some form of normality at the middle until some point when it obviously began to deviate from the line, showing some form of curvature on the plot which indicates some form of non-normality. 
