...
In the `"dummy"` model (8.1), it matters to the model that there is an import or not. However, on the full model, it shows that fitting the model with additional (significant) predictors makes **import** insignificant. In other words, in the full model, it doesn't matter if there was an import or not.
